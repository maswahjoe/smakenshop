( function( $ ) {
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'vw_ecommerce_shop_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'vw_ecommerce_shop_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'vw_ecommerce_shop_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      ...
      if (
        'vw_ecommerce_shop_section' !== this.params.type ||
...
jQuery( document ).ready(function($) {
  var this_obj = vw_ecommerce_shop_customizer_params;
    var api = wp.customize;

  // Reset options
  $('.refresh-btn').on('click', function() {
    var dataValue = $(this).attr('data-value');
    $.get( vw_ecommerce_shop_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
