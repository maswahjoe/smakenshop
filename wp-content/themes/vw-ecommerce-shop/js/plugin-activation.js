jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_ecommerce_shop_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-ecommerce-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-ecommerce-shop-plugin-install');
                button.addClass('button-primary vw-ecommerce-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-ecommerce-shop-recommended-plugins .vw-ecommerce-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-ecommerce-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-ecommerce-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-ecommerce-shop-recommended-plugins').css('display','none');
    });
