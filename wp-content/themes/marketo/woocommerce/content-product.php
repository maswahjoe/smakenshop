...
$col_mobile = marketo_option('shop_grid_column_mobile');
$col_tab = marketo_option('shop_grid_column_tab');
$cat = '';
...
$class = 'col-lg-'.$col.' '.'col-sm-'.$col_tab.' '.'col-'.$col_mobile;
do_action('marketo_list_view');
?>
