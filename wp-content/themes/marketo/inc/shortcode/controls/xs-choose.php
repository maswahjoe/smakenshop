...
class Control_Image_Choose extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'image-choose-control',  MARKETO_CSS . '/image-choose-control.css', [], '1.0.0' );
		wp_enqueue_style( 'image-choose-control' );

		// script	
		wp_register_script( 'image-choose-control',  MARKETO_SCRIPTS . '/image-choose-control.js' );
