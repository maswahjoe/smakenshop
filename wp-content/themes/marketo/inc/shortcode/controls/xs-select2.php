...
class Control_Ajax_Select2 extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_register_script( 'marketoajaxselect2-control',  MARKETO_SCRIPTS . '/marketoajaxselect2-control.js' );
		wp_enqueue_script( 'marketoajaxselect2-control' );
	}
	...
	public function content_template() {
		...
		$restAPi = get_site_url('') . '/wp-json/marketoajaxselect2/v1';
		?>
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select 
					...
					class="elementor-marketoajaxselect2" 
					type="marketoajaxselect2" {{ multiple }} 
