...
abstract class FW_Extension
{
	 ...
	 * @param mixed $value
	 */
	final public function set_db_settings_option( $value, $option_id = null ) {
		fw_set_db_ext_settings_option( $this->get_name(), $value, $option_id );
	}
	 ...
	 * @param mixed $value
	 */
	final public function set_db_data( $value, $multi_key = null ) {
		fw_set_db_extension_data( $this->get_name(), $value, $multi_key );
	}
