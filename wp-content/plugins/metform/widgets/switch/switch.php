		...
		<div class="mf-input-wrapper">
			...
			<span class="mf-input-switch-control mf-input-switch">
				<input type="checkbox"
					...
					value="<?php echo trim(\MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_disable), $render_on_editor )); ?>"
					...
					/>
				<label
					data-enable="<?php echo trim(\MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_enable), $render_on_editor )); ?>"
					data-disable="<?php echo trim(\MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_disable), $render_on_editor )); ?>"
